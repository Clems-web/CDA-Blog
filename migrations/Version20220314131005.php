 ...
 */
final class Version20220314131005 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article CHANGE thumbnail thumbnail VARCHAR(255) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE article CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8_unicode_ci`, CHANGE content content LONGTEXT NOT NULL COLLATE `utf8_unicode_ci`, CHANGE shortdescrition shortdescrition VARCHAR(255) NOT NULL COLLATE `utf8_unicode_ci`, CHANGE thumbnail thumbnail VARCHAR(255) DEFAULT NULL COLLATE `utf8_unicode_ci`');
