 ...
 */
final class Version20220314123732 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP flagged');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD flagged TINYINT(1) NOT NULL, CHANGE content content VARCHAR(255) NOT NULL COLLATE `utf8_unicode_ci`');
